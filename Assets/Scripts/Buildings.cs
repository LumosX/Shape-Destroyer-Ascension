...
public class Buildings {
    ...
    public static Building Residential3 = new Building("Residential III", 220, 3, -10, 15, null,         Produce(Hap: -3));
    public static Building Residential2 = new Building("Residential II",  100, 2,  -5, 10, Residential3, Produce(Hap: -2));
    ...
    public static Building Industrial3 = new Building("Industrial III", 1000, 20, 3, 0, null,        Produce(Hap: -5, Mats: 80));
    public static Building Industrial2 = new Building("Industrial II",   600, 15, 2, 0, Industrial3, Produce(Hap: -2, Mats: 25));
    public static Building Industrial1 = new Building("Industrial I",     40, 10, 1, 0, Industrial2, Produce(Hap: -1, Mats: 10));

    public static Building Military3 = new Building("Military III", 1000, 20, 3, 40, null,      Produce(Hap: -10, Ammo: 6));
    public static Building Military2 = new Building("Military II",   600, 15, 2, 30, Military3, Produce(Hap: -5,  Ammo: 3));
